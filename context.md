...
| **Push category** | Категория пушей | The group a push kind belongs to, as the player chooses it: ход игры, подсказки, команда, организатору. Not a domain concept — the engine knows only kinds — but the unit the profile switches on and off. | `push/push-settings.ts` |
