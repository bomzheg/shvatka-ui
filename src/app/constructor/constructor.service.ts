...
export class ConstructorService {
  ...
  /** The current author's game drafts — a complete game is not listed. */
  listMyGames(): Observable<Page<MyGame>> {
    return this.http.get<Page<MyGame>>("/games/my");
  }

  /** Full game by id, for editing. */
  ...
  /** Set or clear the planned start. */
  ...
  /** Upload a single file (multipart `file`). The optional flags control the
